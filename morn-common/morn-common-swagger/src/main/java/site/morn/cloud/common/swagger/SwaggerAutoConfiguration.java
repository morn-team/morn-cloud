 ...
 *
 */
package site.morn.cloud.common.swagger;
...
import site.morn.cloud.common.swagger.config.SwaggerProperties;
...
public class SwaggerAutoConfiguration {
  ...
  private List<SecurityReference> defaultAuth(SwaggerProperties swaggerProperties) {
    ...
    swaggerProperties.getAuthorization().getAuthorizationScopeList().forEach(
        authorizationScope -> authorizationScopeList.add(
            new AuthorizationScope(authorizationScope.getScope(),
  ...
  private OAuth securitySchema(SwaggerProperties swaggerProperties) {
    ...
    return new OAuth(swaggerProperties.getAuthorization().getName(), authorizationScopeList,
        grantTypes);
  }
