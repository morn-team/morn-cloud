...
import site.morn.cloud.common.security.exception.ForbiddenException;
import site.morn.cloud.common.security.exception.InvalidException;
import site.morn.cloud.common.security.exception.MethodNotAllowed;
import site.morn.cloud.common.security.exception.PigAuth2Exception;
import site.morn.cloud.common.security.exception.ServerErrorException;
import site.morn.cloud.common.security.exception.UnauthorizedException;
...
public class PigWebResponseExceptionTranslator implements WebResponseExceptionTranslator {
  ...
  private ResponseEntity<OAuth2Exception> handleOAuth2Exception(OAuth2Exception e) {
    ...
    return new ResponseEntity<>(new PigAuth2Exception(e.getMessage(), e.getOAuth2ErrorCode()),
        headers,
        HttpStatus.valueOf(status));
