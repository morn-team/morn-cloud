...
package site.morn.cloud.codegen.util;
...
import site.morn.cloud.codegen.entity.TableEntity;
import site.morn.cloud.common.core.constant.CommonConstants;
import site.morn.cloud.common.core.exception.CheckedException;
import java.io.File;
...
/**
 * 代码生成器   工具类 copy elunez/eladmin/blob/master/eladmin-generator/src/main/java/me/zhengjie/utils/GenUtil.java
 *
 * @author Zheng Jie
 * @author lengleng
 * @date 2020-03-13
