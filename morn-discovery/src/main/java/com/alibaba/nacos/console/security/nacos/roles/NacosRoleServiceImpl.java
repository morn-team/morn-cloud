...
public class NacosRoleServiceImpl {
  ...
  public List<PermissionInfo> getPermissions(String role) {
    ...
    if (!authConfigs.isCachingEnabled()) {
      Page<PermissionInfo> permissionInfoPage = getPermissionsFromDatabase(role, 1,
          Integer.MAX_VALUE);
  ...
  public Page<PermissionInfo> getPermissionsByRoleFromDatabase(String role, int pageNo,
      int pageSize) {
  ...
  public void addRole(String role, String username) {
    ...
    if (GLOBAL_ADMIN_ROLE.equals(role)) {
      throw new IllegalArgumentException(
          "role '" + GLOBAL_ADMIN_ROLE + "' is not permitted to create!");
    }
