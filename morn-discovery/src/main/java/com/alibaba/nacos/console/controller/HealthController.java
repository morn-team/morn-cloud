...
public class HealthController {
   ...
   *
   * @return HTTP code equal to 200 indicates that Nacos is in right states. HTTP code equal to 500
   * indicates that Nacos is in broken states.
   */
  @GetMapping("/liveness")
   ...
   *
   * @return HTTP code equal to 200 indicates that Nacos is ready. HTTP code equal to 500 indicates
   * that Nacos is not ready.
   */
